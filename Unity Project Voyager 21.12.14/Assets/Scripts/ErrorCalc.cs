 ...
 * 
 * This script displays a window to calculate the positions of required planets, moons and ships. It can be used to
...
public class ErrorCalc : MonoBehaviour
{
		...
		void Start ()
		{
				errorRect = new Rect (Screen.width - 300, 10, 290, 340);
				errorButton = new Rect (Screen.width - 140, 10, 130, 50);
		}
